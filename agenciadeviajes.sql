...
INSERT INTO `testimoniales` VALUES (4,'Miquel','miquel@correo.com','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eget tortor justo. Cras hendrerit massa non dui tincidunt, sed congue eros gravida. Phasellus ante nisi, tempor at pretium sit amet, venenatis quis est. Phasellus eget auctor nulla. Quisque commodo blandit nibh, ut consectetur libero vulputate ac.'),(5,'Paula','paula@correo.com','Donec nec fringilla justo. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam viverra lorem dolor, mollis commodo metus sodales volutpat. Donec !!!!!!!'),(6,'Karen','karen@correo.com','Fusce aliquet id diam eget varius. Nullam fringilla est pulvinar massa tristique aliquam. Nullam ornare sapien sed massa mollis, ac lacinia magna rhoncus. Maecenas sit amet elit id ligula placerat tincidunt.'),(7,'Miki Controller','controller@correo.com','Desde el controller'),(8,'Un nuevo cliente','async@correo.com','Verificar');
...
-- Dump completed on 2020-07-06 12:23:14
